    ...
    <>
      ...
      <div className="grid">
        <ConceptCard 
          ...
          description="Any file in 'app/api/*/route.ts' is mapped to '/api/*'. These handlers provide JSON data instead of HTML pages."
        />
        <ConceptCard 
          tag="Security"
          title="Server-Only"
        ...
        <ConceptCard 
          tag="Control"
          title="HTTP Methods"
          description="In App Router, you export named functions like GET(), POST(), etc. to handle different HTTP methods."
        />
      </div>
